...
<body>
    ...
    <div class="cart_container rounded p-2 mt-2">
        <?php
        $query = "SELECT * FROM order_table WHERE status = 'placed' AND user_id = '" . $_SESSION['uname'] . "' GROUP BY order_number ORDER BY order_time";   // Filter by status
                            ...
                            <div class="product_details">
                                ...
                                <form action="" method="post">
                                    <div>
                                        ...
                                        <p>Waiting for Sellers confirmation.</p>
                                    </div>
                                </form>
                            </div>
