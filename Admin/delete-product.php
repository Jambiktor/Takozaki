...
if (isset($_POST['remove'])) {
    ...
    $query = "SELECT image_file FROM product_table WHERE product_id = '$product_id'";
    ...
    $deleteProductsQuery = "DELETE FROM product_table WHERE product_id = '$product_id'";
    ...
    $deleteAddOnQuery = "DELETE FROM add_on_table WHERE product_id = '$product_id'";
    ...
    $deleteOptionQuery = "DELETE FROM option_table WHERE product_id = '$product_id'";
    ...
    $query = "SELECT image_file FROM variation_table WHERE product_id = '$product_id'";
    $result = mysqli_query($conn, $query);
    ...
    $deleteVariantsQuery = "DELETE FROM variation_table WHERE product_id = '$product_id'";
