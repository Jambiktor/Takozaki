...
<body data-bs-spy="scroll" data-bs-target="#navId" data-bs-smooth-scroll="true">
...
<body>
    ...
    <div class="cart_container rounded p-2 mt-2">
        <?php
        $query = "SELECT * FROM order_table WHERE status = 'completed'  GROUP BY order_number ORDER BY order_time"; // Filter by status
